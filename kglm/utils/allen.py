"""
    Contains stuff overriding/adding on to the basic functionality of AllenNLP
    For now, we're using this to contain extensions written by KGLM authors, but later we'll use this to create
        stuff like fields, instances etc if we want to completely remove the dependency
"""
import torch
import numpy as np
