"""
    Python really needs to fix its pathgame :/
    You don't need to do this IF you're running this via an IDE and the pythonpaths have been set properly.
    ...
    - but but... pycharm gives module not used error.
        glad you asked. Invoke _pathfx.suppress_unused_import() somewhere. It does nothing.
"""
import os
import sys
